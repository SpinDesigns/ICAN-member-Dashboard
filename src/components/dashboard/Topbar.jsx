              ...
              <div className="page-div">
                <div className="pages">
                  <NavLink to="/dashboard" className="links">
                    ...
                    >
                      <g id="smart-home">
                        <path
                          id="Path"
                          d="M17.4167 7.98418L12.5281 4.18185C11.6455 3.49524 10.4095 3.49524 9.52695 4.18185L4.63745 7.98418C4.04198 8.44725 3.69384 9.15944 3.6942 9.91376V16.5138C3.6942 17.5263 4.51501 18.3471 5.52753 18.3471H16.5275C17.5401 18.3471 18.3609 17.5263 18.3609 16.5138V9.91376C18.3609 9.15935 18.0125 8.4471 17.4167 7.98418"
                          stroke="white"
                          strokeWidth="1.75"
                          strokeLinecap="round"
                        ...
                        <path
                          id="Path_2"
                          d="M14.6667 13.7499C12.6408 14.9718 9.35733 14.9718 7.33333 13.7499"
                          stroke="white"
                          strokeWidth="1.75"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <NavLink to="/message" className="links">
                    ...
                    >
                      <path
                        d="M0.0550003 0.1875H0.7425H13.1175H13.805V0.875V10.5V11.1875H13.1175H7.18781L3.92219 13.7656L2.805 14.7109V13.25V11.1875H0.7425H0.0550003V10.5V0.875V0.1875ZM1.43 1.5625V9.8125H3.4925H4.18V10.5V11.7891L6.50031 9.98438L6.67219 9.8125H6.93H12.43V1.5625H1.43ZM15.18 2.9375H19.305V13.9375H16.555V17.4609L12.1722 13.9375H5.81281L7.53156 12.5625H12.6878L15.18 14.5391V12.5625H17.93V4.3125H15.18V2.9375Z"
                        fill="#ECEDF5"
                      />
                    </svg>
                    <p>Messages</p>
                  ...
                  <NavLink to="/resources" className="links">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M11.9167 1.83333V8.24999H18.3334"
                        stroke="#ECEDF5"
                        stroke-width="2"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                    ...
                    >
                      <g clip-path="url(#clip0_1344_3504)">
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M10 6.19047C10 5.85428 10.072 5.23809 10.184 5.23809H0V7.14285H10.184C10.072 7.14285 10 6.52666 10 6.19047ZM17.816 5.23809C17.403 4.28571 16.304 3.33333 15 3.33333C13.343 3.33333 12 4.61238 12 6.19047C12 7.76857 13.343 9.04761 15 9.04761C16.304 9.04761 17.403 8.09523 17.816 7.14285H20V5.23809H17.816ZM10 13.8095C10 14.1457 9.928 14.4629 9.816 14.7619H20V12.8571H9.816C9.928 12.8571 10 13.4733 10 13.8095ZM8 13.8095C8 15.3876 6.657 16.6667 5 16.6667C3.696 16.6667 2.597 15.7143 2.184 14.7619H0V12.8571H2.184C2.597 11.9048 3.696 10.9524 5 10.9524C6.657 10.9524 8 12.2314 8 13.8095Z"
                          fill="#3D4999"
                        />
                      </g>
                      <defs>
