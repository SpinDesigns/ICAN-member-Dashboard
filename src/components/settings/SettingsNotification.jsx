            ...
            <div className="notification-set">
              ...
              <div className="not-set">
                <div>
                  ...
                  <p>
                    Sent automatically to the customer after they place their
                    order.
                  </p>
                </div>
                <div>
              ...
              <div className="not-set">
                <div>
                  ...
                  <p>
                    Sent to the customer after their order is edited (if you
                    select this option).
                  </p>
                </div>
                <div>
              ...
              <div className="not-set">
                <div>
                  ...
                  <p>
                    Sent to the customer when the order has an outstanding
                    balance.
                  </p>
                </div>
                <div>
              ...
              <div className="not-set">
                <div>
                  ...
                  <p>
                    Sent automatically to the customer if their order is
                    cancelled (if you select this option).
                  </p>
                </div>
                <div>
                  <Switch colorScheme="blue" size="lg" />
